...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(perktree, [{
    ...
    value: function updatePerkLevelList(perkLevel) {
      var foundPerkLevel = this.state.perkLevelList.find(function (perklevelitem) {
        return perklevelitem.title == perkLevel.title;
      });
      console.log(foundPerkLevel); // arr[2].prop = newValue;
...
//# sourceMappingURL=perktree.js.a6026239e9fb7a5ce072.hot-update.js.map