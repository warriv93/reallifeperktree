  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(Perk, [{
    ...
    value: function createPerkLevels(amountOfLevels) {
      for (var index = 1; index < amountOfLevels; index++) {
        return __jsx(_Perklevel__WEBPACK_IMPORTED_MODULE_6__["default"], {
        ...
        for (var _index = 1; _index < amountOfLevels; _index++) {
          return __jsx(_Perklevel__WEBPACK_IMPORTED_MODULE_6__["default"], {
            image: _assets_404Code_jpg__WEBPACK_IMPORTED_MODULE_7__["default"],
            __source: {
              fileName: _jsxFileName,
    ...
    value: function render() {
      return __jsx("div", {
        ...
        __self: this
      }, this.props.title)), this.createPerkLevels(TotalOfLevels)));
    }
  }]);
...
//# sourceMappingURL=perktree.js.fba9db6fa286b6b0d16c.hot-update.js.map