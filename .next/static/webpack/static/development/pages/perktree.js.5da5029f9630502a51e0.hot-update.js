  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(perktree, [{
    ...
    value: function updatePerkLevelList(perkLevel) {
      ...
      var oldPerkLevel = this.state.perkLevelList.find(function (perklevelitem, index) {
        return perklevelitem.title == perkLevel.title && index;
      });

      if (oldPerkLevel) {
        //get index in array of old item
        var indexOfPerkLevel = this.state.perkLevelList.indexOf(oldPerkLevel);
        this.state.perkLevelList[indexOfPerkLevel] = perkLevel;
      } else {
...
//# sourceMappingURL=perktree.js.5da5029f9630502a51e0.hot-update.js.map