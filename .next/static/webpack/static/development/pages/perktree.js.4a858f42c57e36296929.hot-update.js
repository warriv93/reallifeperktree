    ...
    value: function PerklevelClicked(e, perkLevel) {
      ...
      if (!this.state.isAssigned) {
        ...
        this.setState({
          ...
          console.log("PerklevelClicked", this.state.title, perkLevel);
          e.currentTarget.style.opacity = '1';
          this.state.oldElementTarget.style.opacity = '0.6';
          this.setState({
            perkLevel: perkLevel,
            oldElementTarget: e.currentTarget
          });
      ...
      this.props.updatePerkLevel({
        title: this.state.title,
        perkLevel: this.state.perkLevel
      });
    }
  }, {
    key: "render",
...
//# sourceMappingURL=perktree.js.4a858f42c57e36296929.hot-update.js.map