...
function (_Component) {
  ...
  Object(_babel_runtime_corejs2_helpers_esm_createClass__WEBPACK_IMPORTED_MODULE_1__["default"])(perktree, [{
    ...
    value: function updatePerkLevelList(perkLevel) {
      ...
      var oldPerkLevel = this.state.perkLevelList.find(function (perklevelitem, index) {
        if (perklevelitem.title == perkLevel.title) return index;
      }); //get index in array of old item

      var indexOfPerkLevel = oldPerkLevel ? this.state.perkLevelList.indexOf(oldPerkLevel) : null; // arr[2].prop = newValue;

      oldPerkLevel ? this.state.perkLevelList[indexOfPerkLevel] = perkLevel : this.state.perkLevelList.push(perkLevel); //CHECK IF ALREADY EXIST
    }
  }, {
    key: "checkPerkLevels",
...
//# sourceMappingURL=perktree.js.e5e55cdb30efa3acf614.hot-update.js.map